      ...
      <div className="bg-white shadow-md rounded-lg px-8 py-6 max-w-md">
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-3 min-w-72">
            ...
            <input onChange={(e) => setEmail(e.target.value)} className="rounded-md w-full px-3 py-2 border border-gray-300 outline-none" type="email" placeholder="address@yahoo.com" required />
          </div>
          <div className="mb-3 min-w-72">
