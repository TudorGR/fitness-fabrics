    ...
    <div>
      <div className="h-[40px] bg-black flex justify-between items-center">
        <div className="flex gap-6 ml-4">
          ...
          <a
            ...
            rel="noopener noreferrer"
          >
            <img src={assets.X} className="w-3 cursor-pointer" alt="Twitter" />
          </a>
        </div>
        <p className="hidden sm:block text-gray-200 text-xs">
          Free pre-paid return for any orders within 30 days.
        </p>

        <Link
          to="/cart"
          className=" bg-white py-1 px-4 flex items-center gap-2 rounded-full mr-4"
        >
          <img
            draggable="false"
      ...
      <div className="flex items-center justify-between sm:px-4 px-3 md:px-10 h-[60px] border border-white border-b-gray-200 ">
        <ul className="activeUnderline hidden sm:flex gap-2 md:gap-5">
          <NavLink to="/">
            <p className="text-sm md:text-base py-1 font-medium text-gray-600 hover:text-black transition ease-in-out delay-150">
              Home
            </p>
          </NavLink>
        ...
        <div className="absolute left-1/2 transform -translate-x-1/2">
          <Link to="/">
            <img
              draggable="false"
              src={assets.logo}
              className="transform sm:translate-x-[50px] md:translate-x-[100px] lg:translate-x-[0px] h-[58px]"
              alt=""
            />
          </Link>
        </div>
              ...
              {token ? (
                <div className="z-10 rounded-md boxShadow w-[200px] hidden group-hover:block absolute right-0">
                  <div className="bg-white flex flex-col items-start rounded">
                    ...
                    <p
                      className="hover:font-bold px-4 cursor-pointer"
                    ...
                    <button
                      className="rounded-md  w-[90%] py-3 font-medium"
                      onClick={logout}
                    >
                      Logout
                    </button>
                ...
                <div className="z-10 rounded-md boxShadow w-[300px] sm:w-[400px] hidden group-hover:block absolute  right-0">
                  <div className="bg-white flex flex-col items-center rounded">
                    <p className="text-base md:text-lg font-bold py-4">
                      You are not logged in
                    </p>
                    <button
                      className="rounded-md bg-black text-white w-[90%] py-3 font-medium"
                    ...
                    <div className="flex gap-2 sm:gap-6">
                      <div className="flex items-center gap-2">
                        ...
                        <p className="text-sm sm:text-base font-semibold py-4">
                          Exclusive Offers
                        </p>
                      </div>
                      <div className="flex items-center gap-2">
        ...
        <div
          className={`z-10 fixed top-0 right-0 bottom-0 bg-white transition-all ${
            visible ? "w-full sm:hidden" : "w-0 sm:hidden"
          }`}
        >
          <div className="flex flex-col h-full">
            ...
            >
              <img
                draggable="false"
                src={assets.arrow}
                className="transform rotate-180 w-6 cursor-pointer"
                alt=""
              />
              <p>Back</p>
            </div>
