  ...
  return (
    <div>
      <div className="h-[40px] bg-black flex justify-between items-center">
        ...
        <p className="text-gray-200 text-xs">Free pre-paid return for any orders within 30 days.</p>
      ...
      <div className="flex items-center justify-between px-10 h-[60px] border border-white border-b-gray-200 ">
        <ul className="activeUnderline hidden sm:flex gap-5">
          <NavLink to="/">
            <p className="py-1 font-medium text-gray-600 hover:text-black transition ease-in-out delay-150">Home</p>
          </NavLink>
          <NavLink to="/collection">
            <p className="py-1 font-medium text-gray-600 hover:text-black transition ease-in-out delay-150">Collection</p>
          </NavLink>
          <NavLink to="/about">
            <p className="py-1 font-medium text-gray-600 hover:text-black transition ease-in-out delay-150">About</p>
          </NavLink>
          <NavLink to="/contact">
            <p className="py-1 font-medium text-gray-600 hover:text-black transition ease-in-out delay-150">Contact</p>
          </NavLink>
        </ul>
        <div className="absolute left-1/2 transform -translate-x-1/2">
          <Link to="/">
            <img draggable="false" src={assets.logo} className="h-[58px]" alt="" />
          </Link>
        </div>
        <div className="flex flex-row gap-6">
          <img draggable="false" onClick={() => setShowSearch(true)} src={assets.search_icon} className="w-6 cursor-pointer" alt="" />
