    ...
    <div className="m-10 flex flex-col sm:flex-row gap-1 sm:gap-10">
      <div className="min-w-40 md:min-w-60">
        ...
        >
          ...
          <img
            src={assets.arrow}
            className={`h-3 sm:hidden rotate-90 ${
        ...
        <div
          className={`${
            showFilter ? "" : "hidden"
          } sm:block pr-0 p-4 pb-10 mb-10 border-b-gray-300 border border-white`}
        >
        ...
        <div
          className={`border border-white border-b-gray-300 pl-5 py-4 pb-10 my-6 ${
            showFilter ? "" : "hidden"
          } sm:block`}
        >
        ...
        <div
          className={` pl-5 py-3 my-5 ${showFilter ? "" : "hidden"} sm:block`}
        >
        ...
        <div className="flex justify-between text-base sm:text-2xl mb-10 font-medium">
          <div className="flex items-center gap-2">
            <p
              ...
              className="text-neutral-700 font-semibold text-sm md:text-base"
            >
              All Collection
            </p>
          ...
          <select
            ...
            className=" text-xs sm:text-sm bg-none"
          >
