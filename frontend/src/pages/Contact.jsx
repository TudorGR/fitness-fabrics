...
const Contact = () => {
  return (
    <div>
      ...
      <div className="p-10 my-10 flex flex-col md:flex-row justify-center gap-10 mb-28">
        <div className="flex flex-col justify-center items-start gap-6 md:w-1/2">
          <p className="font-semibold text-3xl">Our Store</p>
          <p className="font-medium text-xl sm:text-2xl text-gray-500">123 Fitness St.</p>
          <p className="font-medium text-xl sm:text-2xl text-gray-500">Suite 100</p>
          <p className="font-medium text-xl sm:text-2xl text-gray-500">New York, NY 10001</p>
          <p className="font-medium text-xl sm:text-2xl text-gray-500">tel: +1-555-123-4567</p>
          <p className="font-medium text-xl sm:text-2xl text-gray-500">email: info@fitnessfabrics.com</p>
